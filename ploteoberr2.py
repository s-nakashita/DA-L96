...
#        print(enrs)
        ...
        #    label = pt + " op-av"
#        label = pt
#        ax.plot(obs_s, enr, linestyle=linestyle[1], color=linecolor[pt], label=label)
...
#ax.set_xticks(x, minor=True)
    ax.legend(ncol=3)
    fig.savefig("{}_error_{}_{}.png".format(model, op, pt))
    fig.savefig("{}_error_{}_{}.pdf".format(model, op, pt))
