...
for op in ${operators}; do
  ...
  for pert in ${perturbations}; do
    ...
    echo ${vname} ${na} ${ivar}
    python ${src}/z08-2.py ${op} ${pt} ${linf} ${lloc} ${ltlm} > z08_${op}_${pt}.log 2>&1
    wait
    ...
    mv z08_chi_${op}_${pt}.txt z08_chi_${op}_${pert}.txt
    mv z08_K_${op}_${pt}_cycle0.npy z08_K_${op}_${pert}_cycle0.npy 
